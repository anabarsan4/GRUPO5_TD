...
author: "Funciones  incertidumbre"
date: "`r Sys.Date()`"
...
tablaX: Matriz donde se exponen, por filas, los "beneficios" o "costes"
de

cada decisión, según la alternativa.

alfa: Es un escalar entre 0 y 1. Es el grado de optimismo que tenemos a
la
...
metodo:Si se ha tomado la matriz de entrada como favorable(beneficios) o
...
ValorOptimo: Minima distancia o valor óptimo entre todas las
alternativas.
