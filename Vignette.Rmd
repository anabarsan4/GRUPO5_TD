...
-   *ENTRADA:*
    ...
    -   [tablaX:]{.underline} Matriz donde se ponen los
        "beneficios" o "costes" dependiendo de la alternativa por filas.

    -   [favorable:]{.underline} TRUE si es una matriz de
...
-   *SALIDA:* La función nos devuelve una lista, con:
    ...
    -   [metodo:]{.underline} favorable o desfavorable, dependerá si se ha cogido al principio la matriz de         beneficio o costos.
